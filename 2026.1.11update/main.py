...
DB_CONFIG = {
    # Read from environment variables for safety. Example env names:
    # DB_HOST, DB_USER, DB_PASSWORD, DB_NAME, DB_PORT
    'host': os.getenv('DB_HOST', '127.0.0.1'),
    'user': os.getenv('DB_USER', 'root'),
    'password': os.getenv('DB_PASSWORD', os.getenv('MYSQL_PWD', 'marker86')),
    'database': os.getenv('DB_NAME', 'hololiveofficialcardgame'),
    'port': int(os.getenv('DB_PORT', os.getenv('MYSQL_PORT', '8000')))
}
